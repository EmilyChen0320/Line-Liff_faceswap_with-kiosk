<template>
  <main class="relative min-h-[100dvh] overflow-x-hidden bg-black font-noto-sans-tc text-[#1f1f1f]">
    <img
    ...
    <div class="relative z-10 flex min-h-[100dvh] w-full justify-center px-4 py-6">
      <div
      ...
      >
        ...
        <img
          ...
          alt="LINE 外部瀏覽器操作示範"
          class="relative z-10 block h-auto w-full max-w-[372px]"
          draggable="false"
        />

        <section v-else class="relative z-10 w-full max-w-[360px] text-center">
