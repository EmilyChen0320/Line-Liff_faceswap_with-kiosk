<template>
  <main class="relative min-h-screen overflow-hidden bg-black font-noto-sans-tc text-[#1f1f1f]">
    ...
    <div class="relative z-10 flex min-h-screen w-full justify-center px-4 py-6">
      <div
        class="mx-auto flex w-full max-w-[420px] flex-col items-center bg-center bg-no-repeat px-5 pb-10 pt-8"
...
const panelBackgroundStyle = computed(() => ({
  backgroundImage: `url(${panelBackgroundAsset || imageUrls.enterprise.backgroundShadow})`,
